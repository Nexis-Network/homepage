---
title: Connect an Astro site or application to Nexis Network
subtitle: Set up a Nexis Network project in seconds and connect from an Astro site or application
enableTableOfContents: true
updatedOn: '2023-10-19T23:10:12.824Z'
---

Astro builds fast content sites, powerful web applications, dynamic server APIs, and everything in-between. This topic describes how to create a Nexis Network project and access it from an Astro site or application.


To create a Nexis Network project and access it from an Astro site or application:
...
From your `.astro` files, add the following code snippet to connect to your Nexis Network database:
