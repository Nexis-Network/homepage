---
title: Connect Quarkus (JDBC) to Nexis Network
subtitle: Learn how to connect to Nexis Network from Quarkus using JDBC
...
To connect to Nexis Network from a Quarkus application using the Postgres JDBC Driver:
...
Create a `.env` file in the root of your Quarkus project directory. Configure a JDBC data source using the components of your Nexis Network database connection string and specifying the database kind as shown:
