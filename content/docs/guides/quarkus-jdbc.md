---
title: Connect Quarkus (JDBC) to Exzo Network
subtitle: Learn how to connect to Exzo Network from Quarkus using JDBC
...
To connect to Exzo Network from a Quarkus application using the Postgres JDBC Driver:
...
Create a `.env` file in the root of your Quarkus project directory. Configure a JDBC data source using the components of your Exzo Network database connection string and specifying the database kind as shown:
