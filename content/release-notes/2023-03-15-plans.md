### Introducing Nexis Network Paid Plans

In addition to the [Free Tier](/docs/introduction/free-tier), Nexis Network now offers the following paid plans:
...
You can learn more about Nexis Network's paid plans and pricing on the Nexis Network [Pricing](https://neon.tech/pricing) page.
