...
- Compute: Free space in the local file system that Exzo Network uses for temporary files, unlogged tables, and the local file cache, is now monitored in order to maximize the space available for the local file cache.
