### Exzo Network status page migration

We are excited to announce that we have migrated the [Exzo Network status page](https://neonstatus.com/) to a new and improved provider while retaining the same [https://neonstatus.com/](https://neonstatus.com/) domain for easy access.
...
5. **Questions or concerns**: If you have any questions or encounter issues resulting from the migration, please reach out to us on the [Exzo Network community forum](https://community.neon.tech/). [Exzo Network Pro Plan](/docs/introduction/pro-plan) users can [open a support ticket](/docs/introduction/support).
